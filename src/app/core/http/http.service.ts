...
import { UnitInterceptor } from './unit.interceptor.service';
...
export class HttpService extends HttpClient {
  ...
  constructor(private httpHandler: HttpHandler,
    ...
    if (!this.interceptors) {
      ...
      this.interceptors = [
        ...
        this.injector.get(TimeoutInterceptor),
      ];
    }
  }

  unit(): HttpClient {
    const unitInterceptor = this.injector.get(UnitInterceptor);
    return this.addInterceptor(unitInterceptor);
  }
  ...
  skipDataConvert(): HttpClient {
    return this.removeInterceptor(DataConvertInterceptor);
  }
