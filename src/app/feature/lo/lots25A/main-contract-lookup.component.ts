...
import { Lots25AService } from './lots25A.service';
...
export class Lots25AMainContractLookupComponent {
  ...
  search(reset?: boolean) {
    ...
    this.lots25.getMainContractLookup(Object.assign(this.parameter, { keyword: this.keyword }), this.page)
      // .pipe(finalize(() => { }))
      .subscribe(
        (res) => {
