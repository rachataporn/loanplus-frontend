...
import { Lorf01Service, ReportParam } from '@app/feature/lo/lorf01/lorf01.service';
import { Page, ModalService, SelectFilterService } from '@app/shared';
import { AlertService, LangService, SaveDataService } from '@app/core';
import { from } from 'rxjs';

@Component({
  templateUrl: './lorf01.component.html'
})

export class Lorf01Component implements OnInit {
  ...
  ngOnInit() {
    const saveData = this.saveData.retrive('LORF01');
    ...
    this.route.data.subscribe((data) => {
      this.fromBranchList = data.powerofattorney.Branch;
      this.toBranchList = data.powerofattorney.Branch;
      this.fromCustomerCodeList = data.powerofattorney.BorrowerCode;
      this.toCustomerCodeList = data.powerofattorney.BorrowerCode;
      this.contractNoList = data.powerofattorney.ContractNo;
      this.fromContractNoList = data.powerofattorney.ContractNo;
      this.toContractNoList = data.powerofattorney.ContractNo;
      this.bindDropDownList();
    });
  ...
  print() {
    ...
    this.reportParam.ReportName = 'LORF01';
