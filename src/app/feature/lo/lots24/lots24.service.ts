...
export class Lots24Service {
  ...
  getContractManagement(search: any, page: any) {
    const filter = Object.assign(search, page);
    return this.http.get<any>('loan/ContractManagement/searchRefinance', { params: filter });
  }
  ...
  getContractManageMasterDetail(OldContractId?: any,Id?: any): Observable<any> {
    return this.http.get<any>('loan/ContractManagement/masterDetail', { params: { OldContractId: OldContractId , Id: Id} });
  }
  ...
  checkOldContractStatus(data?:ContractHead,lodata?:LoContractHead){
    console.log(" checkOldContractStatus ");
    return this.http.unit().post<any>('loan/ContractManagement/checkOldContractStatus', data);
  }
  ...
  cancelRefinance(data: any){
    return this.http.unit().put<any>('loan/Mobile/cancelReFinance', data);
  }
  ...
  getMaxLoanAmount(CategoryId: any, CustomerCode: any, CompanyCode: any, CloseRefinance: any, Compose: any, LoanContractType: any, LoanLimitAmount: any, TypeOfPay: any, MortgageOnly: any, RefinanceType: any, RefinanceAmount: any) {
    return this.http.get<any>('loan/ContractManagement/getMaxLoanAmount', { params: { CategoryId: CategoryId, CustomerCode: CustomerCode, CompanyCode: CompanyCode, CloseRefinance: CloseRefinance, Compose: Compose, LoanContractType: LoanContractType, LoanLimitAmount: LoanLimitAmount, TypeOfPay: TypeOfPay, MortgageOnly: MortgageOnly, RefinanceType: RefinanceType, RefinanceAmount: RefinanceAmount} });
  }

  getLoanTypeC16(CategoryId: any, CustomerCode: any, CompanyCode: any, CloseRefinance: any, Compose: any, LoanContractType: any, LoanLimitAmount: any, TypeOfPay: any, MortgageOnly: any, RefinanceType: any, RefinanceAmount: any) {
    return this.http.get<any>('loan/ContractManagement/getLoanType', { params: { CategoryId: CategoryId, CustomerCode: CustomerCode, CompanyCode: CompanyCode, CloseRefinance: CloseRefinance, Compose: Compose, LoanContractType: LoanContractType, LoanLimitAmount: LoanLimitAmount, TypeOfPay: TypeOfPay, MortgageOnly: MortgageOnly, RefinanceType: RefinanceType, RefinanceAmount: RefinanceAmount } });
  }

  getDefaultCompany(CustomerCode: any, ){
    return this.http.get<any>('loan/ContractManagement/GetDefaultCompany', { params: { CustomerCode: CustomerCode} });
  }

  getAddressCompany(CustomerCode: any, ){
    return this.http.get<any>('loan/ContractManagement/GetAddressCompany', { params: { CustomerCode: CustomerCode} });
  }
}
