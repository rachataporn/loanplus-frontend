...
import { Lots24Service, ContractStatus, RequestStatus , AcceptStatus  } from '@app/feature/lo/lots24/lots24.service';
import { Page, ModalService, ModalRef, Size, SelectFilterService } from '@app/shared';
import { AlertService, LangService, SaveDataService } from '@app/core';

@Component({
    templateUrl: './lots24.component.html'
})

export class Lots24Component implements OnInit {
   ...
   // RequestNumber:string;
    constructor(
        ...
        private lots24Service: Lots24Service,
    ...
    requestStatusForm(item: RequestStatus): FormGroup {
        ...
        fg.patchValue(item, { emitEvent: false });
        if(fg.value.Value=='WP'||fg.value.Value=='WB') fg.controls.Active.setValue(true);
        return fg;
    }
    ...
    acceptStatusForm(item: AcceptStatus): FormGroup {
        ...
        fg.patchValue(item, { emitEvent: false });
        if(fg.value.Value=='W'||fg.value.Value=='A') fg.controls.Active.setValue(true);
        return fg;
    }
    ...
    ngOnInit() {
        let saveData = this.saveData.retrive("LOTS24");
        ...
        this.route.data.subscribe((data) => {
            this.company = data.lots24.Companys;
            this.loanType = data.lots24.loanTypes;
            this.loanContractType = data.lots24.ContractType;
            this.loanContractStatus = data.lots24.ContractStatus;
            this.loanRequestStatus = data.lots24.RequestStatus; 
            this.loanAcceptStatus = data.lots24.AcceptStatus;
        })
    ...
    ngOnDestroy() {
        this.saveData.save(this.searchForm.value, "LOTS24");
    }
    ...
    search() {
        ...
        this.lots24Service.getContractManagement(Object.assign({
