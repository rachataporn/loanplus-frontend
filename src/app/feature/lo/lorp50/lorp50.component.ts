...
import { Lorp50Service, ReportParam } from './lorp50.service';
import { Page, ModalService } from '@app/shared';
import { AlertService, LangService, SaveDataService } from '@app/core';
import { SelectFilterService } from '../../../shared/service/select-filter.service';

@Component({
  templateUrl: './Lorp50.component.html'
})

export class Lorp50Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.data.subscribe((data) => {
      this.FromBranchList = data.lorp50.Branch;
      this.ToBranchList = data.lorp50.Branch;
    })
    this.bindDropdownlist();
  }
