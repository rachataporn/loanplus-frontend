...
import { Lots25CService, ContractStatus ,  RequestStatus , AcceptStatus } from '@app/feature/lo/lots25C/lots25C.service';
import { Page, ModalService, ModalRef, Size, SelectFilterService } from '@app/shared';
import { AlertService, LangService, SaveDataService } from '@app/core';

@Component({
    templateUrl: './lots25C.component.html'
})

export class Lots25CComponent implements OnInit {
    ...
    constructor(
        ...
        private lots25Service: Lots25CService,
    ...
    ngOnInit() {
        let saveData = this.saveData.retrive("LOTS25C");
        ...
        this.route.data.subscribe((data) => {
            ...
            this.company = data.lots25C.Companys;
            this.loanType = data.lots25C.loanTypes;
            this.loanContractType = data.lots25C.ContractType;
            this.loanContractStatus = data.lots25C.ContractStatus;
            this.loanRequestStatus = data.lots25C.RequestStatus;
            this.loanAcceptStatus = data.lots25C.AcceptStatus;
        })
    ...
    // ngOnDestroy() {
    //     this.saveData.save(this.searchForm.value, "LOTS25C");
    // }
