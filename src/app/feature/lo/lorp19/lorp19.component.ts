...
import { Lorp19Service, ReportParam, ContractStatus } from '@app/feature/lo/lorp19/lorp19.service';
import { Page, ModalService, SelectFilterService, RowState } from '@app/shared';
import { AlertService, LangService, SaveDataService } from '@app/core';
import { Lorp19LookupLoantypeComponent } from './lorp19-lookup-loantypefrom.component';
import { Lorp19LookupCostomerCodeComponent } from './lorp19-lookup-customercodefrom.component';
import { LoginComponent } from '@app/account/login/login.component';
import { moment } from 'ngx-bootstrap/chronos/test/chain';
@Component({
  templateUrl: './lorp19.component.html'
})

export class Lorp19Component implements OnInit {
  Lorp19LookupLoantypeContent = Lorp19LookupLoantypeComponent;
  Lorp19LookupCostomerCodeContent = Lorp19LookupCostomerCodeComponent;
  reportTypeList = [];
  statusPage: boolean;
  ...
  ngOnInit() {
    const saveData = this.saveData.retrive('LORP19');
    ...
    this.route.data.subscribe((data) => {
      this.fromBranchList = this.toBranchList = data.lorp19.Branch;
      this.loanTypeList = data.lorp19.LoanType;
      this.fromLoanTypeList = this.toLoanTypeList = data.lorp19.LoanType;
      this.fromCustomerCodeList = this.toCustomerCodeList = data.lorp19.CustomerCode;
      this.reportTypeList = data.lorp19.ReportType;
      this.contractStatusList = data.lorp19.ContractStatus;
      this.reportFormatList = data.lorp19.reportFormate;
      // this.reportFormatList = data.lorp19.ReportFormat;
      this.bindDropDownList();
  ...
  ngOnDestroy() {
    this.saveData.save(this.searchForm.value, 'LORP19');
  }
  ...
  print() {
    ...
    this.reportParam.ReportName = 'LORP19_' + this.searchForm.controls.ReportPattern.value;
