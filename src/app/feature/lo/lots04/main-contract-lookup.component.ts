...
export class MainContractLookupComponent {
  ...
  search(reset?: boolean) {
    ...
    this.lots04.getMainContractLookup(Object.assign(this.parameter, { keyword: this.keyword }), this.page)
      // .pipe(finalize(() => { }))
      .subscribe(
        (res) => {
