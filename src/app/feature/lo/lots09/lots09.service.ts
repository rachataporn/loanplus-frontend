...
@Injectable()
export class Lots09Service {
  constructor(private http: HttpClient) { }

  getMaster(isDetail): Observable<any> {
    return this.http.get<any>('loan/receiptdetail/master', { params: { isDetail: isDetail } });
  }
  ...
  getReceiptDetailList(search: any, page: any) {
    ...
    return this.http.get<any>('loan/receiptdetail/getReceiptDetailList', { params: param });
  }
  ...
  getContractLOV(search: any, page: any) {
    ...
    return this.http.get<any>('loan/receiptdetail/getContractLOV', { params: param });
  }
  ...
  getReceiptLOV(search: any, page: any) {
    ...
    return this.http.get<any>('loan/receiptdetail/getReceiptLOV', { params: param });
  }
  ...
  getReceiptDetail(ReceiptHeadId) {
    ...
    return this.http.get<any>('loan/receiptdetail/getReceiptDetail', { params: param });
  }

  printInvoice(data: ReportDto) {
    return this.http.post<any>('loan/receiptdetail/printReceipt', data);
  }

  saveCancelReceipt(data: Cancel) {
    return this.http.put<any>('loan/receiptdetail/cancelReceipt', data);
  }
}
