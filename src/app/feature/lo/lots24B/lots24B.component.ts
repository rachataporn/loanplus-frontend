...
import { Lots24BService, ContractStatus, RequestStatus , AcceptStatus  } from '@app/feature/lo/lots24B/lots24B.service';
import { Page, ModalService, ModalRef, Size, SelectFilterService } from '@app/shared';
import { AlertService, LangService, SaveDataService } from '@app/core';

@Component({
    templateUrl: './lots24B.component.html'
})

export class Lots24BComponent implements OnInit {
   ...
   // RequestNumber:string;
    constructor(
        ...
        private lots24BService: Lots24BService,
    ...
    requestStatusForm(item: RequestStatus): FormGroup {
        ...
        // fg.patchValue(item, { emitEvent: false });
        // if(fg.value.Value=='WP'||fg.value.Value=='WP') fg.controls.Active.setValue(true);
        return fg;
    }
    ...
    ngOnInit() {
        let saveData = this.saveData.retrive("LOTS24B");
        ...
        this.route.data.subscribe((data) => {
            this.company = data.lots24B.Companys;
            this.loanType = data.lots24B.loanTypes;
            this.loanContractType = data.lots24B.ContractType;
            this.loanContractStatus = data.lots24B.ContractStatus;
            this.loanRequestStatus = data.lots24B.RequestStatus; 
            this.loanAcceptStatus = data.lots24B.AcceptStatus;
        })
    ...
    ngOnDestroy() {
        this.saveData.save(this.searchForm.value, "LOTS24B");
    }
    ...
    search() {
        ...
        this.lots24BService.getContractManagement(Object.assign({
