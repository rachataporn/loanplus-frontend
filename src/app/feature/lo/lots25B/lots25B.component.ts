...
import { Lots25BService, ContractStatus ,  RequestStatus , AcceptStatus } from '@app/feature/lo/lots25B/lots25B.service';
import { Page, ModalService, ModalRef, Size, SelectFilterService } from '@app/shared';
import { AlertService, LangService, SaveDataService } from '@app/core';

@Component({
    templateUrl: './lots25B.component.html'
})

export class Lots25BComponent implements OnInit {
    ...
    constructor(
        ...
        private lots25Service: Lots25BService,
    ...
    requestStatusForm(item: RequestStatus): FormGroup {
        ...
        fg.patchValue(item, { emitEvent: false });
        if(fg.value.Value=='WP'||fg.value.Value=='I') fg.controls.Active.setValue(true);
    ...
    ngOnInit() {
        let saveData = this.saveData.retrive("LOTS25B");
        ...
        this.route.data.subscribe((data) => {
            ...
            this.company = data.lots25B.Companys;
            this.loanType = data.lots25B.loanTypes;
            this.loanContractType = data.lots25B.ContractType;
            this.loanContractStatus = data.lots25B.ContractStatus;
            this.loanRequestStatus = data.lots25B.RequestStatus;
            this.loanAcceptStatus = data.lots25B.AcceptStatus;
        })
    ...
    ngOnDestroy() {
        this.saveData.save(this.searchForm.value, "LOTS25B");
    }
