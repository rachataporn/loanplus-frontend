...
import { Lots25Service, ContractStatus ,  RequestStatus , AcceptStatus } from '@app/feature/lo/lots25/lots25.service';
import { Page, ModalService, ModalRef, Size, SelectFilterService } from '@app/shared';
import { AlertService, LangService, SaveDataService } from '@app/core';

@Component({
    templateUrl: './lots25.component.html'
})

export class Lots25Component implements OnInit {
    ...
    constructor(
        ...
        private lots25Service: Lots25Service,
    ...
    ngOnInit() {
        let saveData = this.saveData.retrive("LOTS25");
        ...
        this.route.data.subscribe((data) => {
            ...
            this.company = data.lots25.Companys;
            this.loanType = data.lots25.loanTypes;
            this.loanContractType = data.lots25.ContractType;
            this.loanContractStatus = data.lots25.ContractStatus;
            this.loanRequestStatus = data.lots25.RequestStatus;
            this.loanAcceptStatus = data.lots25.AcceptStatus;
        })
    ...
    ngOnDestroy() {
        this.saveData.save(this.searchForm.value, "LOTS25");
    }
