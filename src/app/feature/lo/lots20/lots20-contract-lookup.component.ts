...
import { Lots20Service } from './lots20.service';

@Component({
  templateUrl: './lots20-contract-lookup.component.html'
})
export class Lots20ContractLookupComponent implements OnInit {
  itemsLOV = [];
  page = new Page();
  result: Subject<any>;
  ...
  search() {
    ...
    this.searchForm.controls.CompanySource.setValue(this.CompanySource);
