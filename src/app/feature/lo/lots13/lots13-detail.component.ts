...
import { Lots13Service, Securities, SecuritiesAttribute, SecuritiesImage, SecuritiesRegisterRef } from './lots13.service';
import { finalize, switchMap } from 'rxjs/operators';
import { Observable } from 'rxjs';
import { Category } from '@app/shared/service/configuration.service';
import { SecuritiesHistoryVerifyDetailPopupComponent } from './lots13-history-verify-detail.component';

@Component({
  templateUrl: './lots13-detail.component.html',
  providers: [FormsControlService]
})
export class Lots13DetailComponent implements OnInit {
  ...
  createForm() {
    ...
    this.requestSecuritiesForm.controls.SecuritiesCategoryId.valueChanges.subscribe(
      (value) => {
        if (value == 5 || value == 1) {
          this.requestSecuritiesForm.controls.MortgageAmount.setValue(null);
          this.requestSecuritiesForm.controls.MortgageAmount.enable();
        } else {
          this.requestSecuritiesForm.controls.MortgageAmount.setValue(null);
          this.requestSecuritiesForm.controls.MortgageAmount.disable();
        }
  ...
  ngOnInit() {
    ...
    if (this.RegisRefId) {
      this.lots13Service.getRegisRef(this.RegisRefId).subscribe(
    ...
    this.route.data.subscribe((data) => {
      this.securitiesMaster = data.requestSecure.SecuritiesDetail;
      this.assetTypeList = data.requestSecure.master.AssetList;
      this.docStatusList = data.requestSecure.master.DocStatusList;
      this.ReqSecuritiesBy = data.requestSecure.master.ReqSecuritiesBy;
      this.province = data.requestSecure.province.LoanTypesDto;
      this.brandCar = data.requestSecure.brandCar.LoanTypesDto;
      this.brandMotorcycle = data.requestSecure.brandMotorcycle.LoanTypesDto;
  ...
  rebuildForm() {
    ...
    if (this.securitiesMaster.SecuritiesCode != null) {
      ...
      this.requestSecuritiesForm.controls.EndTransferInheritanceDate.disable({ emitEvent: false });
      ...
      if (this.RegisRefId ? this.RegisRefId : this.requestSecuritiesForm.controls.RefRegisterId.value) {
        this.lots13Service.getRegisRef(this.RegisRefId ? this.RegisRefId : this.requestSecuritiesForm.controls.RefRegisterId.value).subscribe(
          (res: SecuritiesRegisterRef) => {
            this.securitiesRegisRef = res;
  ...
  getSecuritiesAttributes(SecuritiesType: string, SecuritiesCode: string) {
    if (SecuritiesType) {
      this.lots13Service.getSecuritiesAttributes(SecuritiesType, SecuritiesCode).subscribe(
        async (res) => {
  ...
  getTemplateView(TemplateViewID?: number, SecuritiesCode: string = null) {
    if (TemplateViewID) {
      this.lots13Service.getImageDetails(TemplateViewID, SecuritiesCode).subscribe(
        (res) => {
  ...
  onSubmit() {
    ...
    if (!this.approved) {
      ...
      this.lots13Service.checkDuplicate(this.requestSecuritiesForm.controls['SecuritiesCategoryId'].value, this.securitiesMaster.SecuritiesAttribute
        , this.requestSecuritiesForm.controls['SecuritiesCode'].value, this.requestSecuritiesForm.controls['Description'].value, this.requestSecuritiesForm.controls['Flag'].value).pipe(
          finalize(() => {
          }))
        .subscribe(
          (res: boolean) => {
            if (res) {
              this.saving = true;
              this.lots13Service.saveRequestSecurities(this.securitiesMaster, this.imageFiles).pipe(
                switchMap((code) => {
                  return this.lots13Service.getSearchEdit(code || this.securitiesMaster.SecuritiesCode);
                }),
                finalize(() => {
                  this.saving = false;
              ...
              this.as.warning('', 'Message.STD00004', ['Label.LOTS13.SecuritiesDescription']);
            }
          }
        );
    } else {
      ...
      this.lots13Service.reApproveSecurities(param).pipe(
        switchMap((code) => {
          return this.lots13Service.getSearchEdit(code || this.securitiesMaster.SecuritiesCode);
        }),
        finalize(() => {
  ...
  back() {
    if (this.RegisRefId) {
      ...
      this.router.navigate(['/lo/lots13'], { skipLocationChange: true });
    }
  }
  ...
  toFormGroup(forms: FormsBase<any>[]) {
    ...
    forms.forEach(form => {
      ...
      } else if ((form.labelEng == 'District' || form.labelEng == 'Subdistrict' || form.labelEng == 'Generation' || form.labelEng == 'Mould' || form.labelEng == 'Year' || form.labelEng == 'Body number' || form.labelEng == 'EngineNumber' || form.labelEng == 'CarModelCode')) {
        ...
        val => {
          if (this.requestSecuritiesForm.controls.SecuritiesCategoryId.value == 2) {
            ...
            if (form.labelEng == 'Year') {
              ...
              if (mouldVal && val || (val && this.approved)) {
            ...
            if (form.labelEng == 'Year') {
              ...
              if ((EngineNumberVal && val) || (val && this.approved)) {
                this.checkButton = true;
    ...
    if (group[ddlKeep.key]) {
      if (value) {
        if (this.requestSecuritiesForm.controls.SecuritiesStatus.value == '3' || this.requestSecuritiesForm.controls.SecuritiesStatus.value == '4'
          ...
          group[ddlKeep.key].enable({ emitEvent: false });
          if (group[ddlKeep.key].value != null || this.approved) {
  ...
  getEngineNumber(generation, formsEngine, i, group) {
    ...
    this.lots13Service.getEngineNumber(modelName, generation).subscribe(
      (res: any) => {
  ...
  getBodyNumber(generation, formsBody, i, group) {
    ...
    this.lots13Service.getBodyNumber(generation).subscribe(
      (res: any) => {
  ...
  getMould(generation, forms, index, group) {
    this.lots13Service.getMould(generation).subscribe(
      (res: any) => {
  ...
  GetGenerationMotorcycle(brand, formsGen, index, group) {
    this.lots13Service.getGenerationMotorcycleDDL(brand).subscribe(
      (res: any) => {
  ...
  GetGeneration(brand, forms, index, group) {
    this.lots13Service.getGeneration(brand).subscribe(
      (res: any) => {
  ...
  GetDistrict(province, forms, index, group) {
    this.lots13Service.getDistrict(province).subscribe(
      (res: any) => {
  ...
  GetSubDistrict(district, forms, index, group) {
    this.lots13Service.getSubDistrict(district).subscribe(
      (res: any) => {
  ...
  checkEstimateAmount(year, mouldVal) {
    if (this.requestSecuritiesForm.controls.SecuritiesAttributes.value != null) {
      ...
      if (this.requestSecuritiesForm.controls.SecuritiesCategoryId.value == 2 && brand != '' && gen != '') {
        this.lots13Service.getCheckEstimateAmount(brand, gen, mould, year).subscribe(
          (res) => {
        ...
        this.lots13Service.getCheckEstimateAmountMotorycle(brand, gen, bodyNumber, engineNumber, carModelCode, year).subscribe(
          (res) => {
            let price = res.EstimateAmountsData;
            if (price.length > 0) {
              let EstimateAmount = res.EstimateAmountsData[0].Price
              this.requestSecuritiesForm.controls.EstimateAmount.enable();
              this.requestSecuritiesForm.controls.EstimateAmount.setValue(EstimateAmount, { emitEvent: false });
              this.requestSecuritiesForm.controls.EstimateAmount.disable();
            } else {
              this.requestSecuritiesForm.controls.EstimateAmount.enable();
              this.requestSecuritiesForm.controls.EstimateAmount.setValue(0), { emitEvent: false };
              this.requestSecuritiesForm.controls.EstimateAmount.disable();
              this.as.warning('', 'Message.LO00032');
            }
          });
