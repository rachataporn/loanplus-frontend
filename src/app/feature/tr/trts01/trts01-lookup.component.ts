...
import { Trts01Service } from './trts01.service';

@Component({
    templateUrl: './trts01-lookup.component.html'
})
export class Trts01LookupComponent implements OnInit {
    itemsLOV = [];
    count = 0;
    page = new Page();
