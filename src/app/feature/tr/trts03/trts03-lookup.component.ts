...
import { Trts03Service } from './trts03.service';

@Component({
    templateUrl: './trts03-lookup.component.html'
})
export class Trts03LookupComponent implements OnInit {
    itemsLOV = [];
    count = 0;
    page = new Page();
