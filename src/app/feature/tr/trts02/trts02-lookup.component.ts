...
import { Trts02Service } from './trts02.service';

@Component({
    templateUrl: './trts02-lookup.component.html'
})
export class Trts02LookupComponent implements OnInit {
    itemsLOV = [];
    count = 0;
    page = new Page();
