...
import { SettingAlertService } from './setting-alert.service';
@Injectable()
export class SettingAlertResolver implements Resolve<any> {
  constructor(private js: SettingAlertService) { }
