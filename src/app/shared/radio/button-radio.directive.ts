...
import {
  ...
  export class ButtonRadioDirective implements ControlValueAccessor, OnInit {
    ...
    set value(value: any) {
      this.group ? this.group.value = value : this._value = value; 
    }
    ...
    constructor(
      ...
      private renderer: Renderer2
       ...
       if(this.group) {
         this.group.disableStateChange.subscribe(
             (state:boolean)=>{
    ...
    setDisabledState(disabled: boolean): void {
      ...
      else this.renderer.removeAttribute(this.el.nativeElement, 'disabled');
    }
  }