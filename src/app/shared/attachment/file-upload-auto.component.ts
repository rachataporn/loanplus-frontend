...
@Component({
    selector: 'file-upload-auto',
    templateUrl: './file-upload-auto.component.html',
    styleUrls: ['./file-upload-auto.component.scss'],
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: FileUploadAutoComponent, multi: true }
    ]
})
export class FileUploadAutoComponent implements ControlValueAccessor {
    error: string;
